...
function ProjectCard({ title, description, imageSrc, onClick }: ProjectCardProps) {
  return (
    <button
      onClick={onClick}
      className="group bg-white rounded-[16px] overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 text-left flex flex-col h-full cursor-pointer"
    >
