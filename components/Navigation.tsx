...
export const LeadershipIcon = ({ size = 24 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 24 24" id="book-open" className="block size-full">
    ...
    <path fill="#024493" fillRule="evenodd" d="M12 3.6437ZM11 19.8745V5.42678C9.29946 3.86914 7.07321 3 4.75736 3H4C3.44771 3 3 3.44772 3 4V18H4.85786C7.06191 18 9.19776 18.6615 11 19.8745ZM13 19.8745C14.8022 18.6615 16.9381 18 19.1421 18H21V4C21 3.44772 20.5523 3 20 3H19.2426C16.9268 3 14.7005 3.86914 13 5.42678V19.8745Z" clipRule="evenodd"></path>
